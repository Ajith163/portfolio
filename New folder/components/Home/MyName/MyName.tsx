...
const MyName: React.FC<MyNameProps> = props => {
  ...
  return (
    ...
    >
      ...
      >
        Hello 🙋‍♂️! I'm Ajith Kumar, a dynamic and enthusiastic <span className="font-bold">Full-time Frontend Developer</span> with 2.7 years of experience. I am passionate about web design and development, primarily specializing in front-end technologies. A firm believer in my abilities, I thrive in challenging environments and enjoy collaborating as a team player, dedicated to building high-quality, user-centric web applications.
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        ...
        className="mt-12"
      >
        <a href={"/AjithResume.pdf"} target={"_blank"} rel="noreferrer">
